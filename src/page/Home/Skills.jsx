        ...
        <div id="skills" className="my-16 max-w-[1300px] mx-auto ">
            ...
            <div className="flex flex-col md:flex-row md:justify-between">
                ...
                <div data-aos="flip-left"
                    ...
                    data-aos-duration="2000" className="relative flex  m-2 flex-col mt-6  bg-black text-white shadow-md border border-fuchsia-500  rounded-xl md:w-1/3 max-w-[24rem]">
                ...
                <div data-aos="flip-left"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="2000" className="relative flex m-2 flex-col mt-6  bg-black text-white  border border-fuchsia-500 shadow-2xl rounded-xl md:w-1/3 max-w-[24rem]">
