    ...
    return (
        <div id="skills" className="my-16">
            ...
            <div className="flex flex-col md:flex-row md:justify-between">
                ...
                <div className="relative flex m-2 flex-col mt-6  bg-black text-white shadow-md border border-fuchsia-500  rounded-xl md:w-1/3">
                ...
                <div className="relative flex m-2 flex-col mt-6  bg-black text-white  border border-fuchsia-500 shadow-2xl rounded-xl md:w-1/3">
